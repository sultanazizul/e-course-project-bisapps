...
if(isset($_POST['like_content'])){
   ...
   if($user_id != ''){
      ...
      $content_id = filter_var($content_id, 513);
...
if(isset($_POST['add_comment'])){
   ...
   if($user_id != ''){
      ...
      $comment_box = filter_var($comment_box, 513);
      $content_id = $_POST['content_id'];
      $content_id = filter_var($content_id, 513);
...
if(isset($_POST['delete_comment'])){
   ...
   $delete_id = filter_var($delete_id, 513);
...
if(isset($_POST['update_now'])){
   ...
   $update_id = filter_var($update_id, 513);
   $update_box = $_POST['update_box'];
   $update_box = filter_var($update_box, 513);
...
<?php
   if(isset($_POST['edit_comment'])){
      ...
      $edit_id = filter_var($edit_id, 513);
